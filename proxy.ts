...
const PUBLIC_PATHS = ["/login", "/auth", "/set-password", "/unauthorized", "/api/cron", "/api/telegram/webhook", "/api/rafael/webhook", "/api/sync", "/api/facebook-sync", "/api/fal-test", "/api/threads/generate", "/api/fix-liam"]
