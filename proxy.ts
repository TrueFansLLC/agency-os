...
const PUBLIC_PATHS = ["/login", "/auth", "/set-password", "/unauthorized", "/api/cron", "/api/telegram", "/api/rafael", "/api/debug", "/api/accounts", "/api/accounts/import", "/api/creators", "/api/markets"]
